...
public class ModRepoController extends AbstractController
{
	...
	public String submit(@ModelAttribute(AbstractController.NAMED_MODEL) ModRepoBean model) {
		try {

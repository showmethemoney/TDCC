...
public class SECSTLM
{
	...
	public SECSTLM(SecStlm secStlm) {
		...
		getItems().add( new PRTY().getSTLMPRTY().add( new STLMPRTY( secStlm.getPrty().getStlmprty() ) ) );
		getItems().add( new CPRTY().getSTLMPRTY().add( new STLMPRTY( secStlm.getCprty().getStlmprty() ) ) );

 ...
 *       &lt;attribute name="NET_CSH_AMT" use="required" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "CONS_REI_NOTE")
public class CONSREINOTE {
    ...
    @XmlAttribute(name = "NET_CSH_AMT", required = true)
    @XmlSchemaType(name = "anySimpleType")
     ...
     *     
     */
    public void setNETCSHAMT(String value) {

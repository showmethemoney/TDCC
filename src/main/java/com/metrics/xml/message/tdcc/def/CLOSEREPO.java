...
public class CLOSEREPO
{
	...
	protected static final Logger logger = LoggerFactory.getLogger( CLOSEREPO.class );
	...
	public CLOSEREPO(CloseRepo closeRepo) {
		...
		logger.info( "getItems().size() : {}", getItems().size() );

		for (Object obj : getItems()) {
			logger.info( "{}, {} ",obj.toString(), obj.getClass().getName() );
			if (obj instanceof PRTY) {
				logger.info( "((PRTY) obj).getSTLMPRTY().size():{}", ((PRTY) obj).getSTLMPRTY().size() );
			}
			
			if (obj instanceof CPRTY) {
				logger.info( "((CPRTY) obj).getSTLMPRTY().size():{}", ((CPRTY) obj).getSTLMPRTY().size() );
			}
		}

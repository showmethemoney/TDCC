...
import com.metrics.bean.SecGenLeg;
import com.metrics.bean.SecLeg;
...
public class CSHADVICE
{
	...
	public CSHADVICE(CshAdvice cshAdvice) {
		...
		getItems().add( new PRTY().getSTLMPRTY().add( new STLMPRTY( cshAdvice.getPrty().getStlmprty() ) ) );
		getItems().add( new CPRTY().getSTLMPRTY().add( new STLMPRTY( cshAdvice.getCprty().getStlmprty() ) ) );
		...
		SECGENLEG secGenLeg = new SECGENLEG( null, cshAdvice.getSecLeg().getSecGenLeg().getGenid(), cshAdvice.getSecLeg().getSecGenLeg().getSecamt() );
		...
		setCSHSYS( cshAdvice.getCshsys() );
		setFTREF( cshAdvice.getFtref() );
		setHEALINSUFEE( cshAdvice.getHealinsufee() );
		setRDMPTAXAMT( cshAdvice.getRdmptaxamt() );
		setREF( cshAdvice.getRef() );
		setTSFSIDE( cshAdvice.getTsfside() );
	}

...
{ DatabaseConfig.class, TDCCMessageQueueConfig.class, MessageQueueConfig.class, OXMConfig.class, ScheduleConfig.class })
...
public class AppConfig
{
	...
	public TCBConfig tcbConfig() {
		TCBConfig config = new TCBConfig( env.getProperty( "participantId" ), env.getProperty( "request.save.xml.path" ),
		        env.getProperty( "response.save.xml.path" ) );

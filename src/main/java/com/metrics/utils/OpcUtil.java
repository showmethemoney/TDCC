...
public class OpcUtil
{
	...
	public static int loginRA(RAFacade2 raFacade, String loginId, String password) throws NoSuchAlgorithmException, OPCException {
		int result = raFacade.FSRA2_Login( loginId, OpcUtil.passwordHash( password ), "" );

		if (0 != result) {
			throw new OPCException( "LoginRA()->Error = " + raFacade.FSRA2_GetErrorMsg() );
		}

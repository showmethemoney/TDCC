	...
	<form:form method="POST" action="ModRepo" modelAttribute="model">
		<table>
			...
			<tbody>
				...
				<tr>
					<td><form:label path="body.prtyid"><span class="required">＊</span><spring:message code="modRepo.prtyid" /></form:label></td>
					<td><form:input path="body.prtyid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.cprtyid"><span class="required">＊</span><spring:message code="modRepo.cprtyid" /></form:label></td>
					<td><form:input path="body.cprtyid" /></td>
				</tr>						
				<tr>
					<td><form:label path="body.cntrid"><span class="required">＊</span><spring:message code="modRepo.cntrid" /></form:label></td>
					<td><form:input path="body.cntrid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.trdrt"><span class="required">＊</span><spring:message code="modRepo.trdrt" /></form:label></td>
					<td><form:input path="body.trdrt" /></td>
				</tr>						
				<tr>
					<td><form:label path="body.secLeg.isin"><span class="required">＊</span><spring:message code="modRepo.secLeg.isin" /></form:label></td>
					<td><form:input path="body.secLeg.isin" /></td>
				</tr>	
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.genid"><span class="required">＊</span><spring:message code="modRepo.secLeg.secGenLeg.genid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.frstLeg.cshLeg.cshamt"><span class="required">＊</span><spring:message code="modRepo.secLeg.secGenLeg.frstLeg.cshLeg.cshamt" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.scndLeg.cshLeg.cshamt"><span class="required">＊</span><spring:message code="modRepo.secLeg.secGenLeg.scndLeg.cshLeg.cshamt" /></form:label></td>

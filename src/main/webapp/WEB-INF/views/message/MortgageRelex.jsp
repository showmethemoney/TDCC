	...
	<form:form method="POST" action="MortgageRelex" modelAttribute="model">
		<table>
			...
			<tbody>
				...
				<tr>
					<td><form:label path="body.stlmprty.prtyid"><spring:message code="mortgageRelex.stlmprty.prtyid" /></form:label></td>
					<td><form:input path="body.stlmprty.prtyid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.stlmprty.acctid"><spring:message code="mortgageRelex.stlmprty.acctid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.frstLeg.taxImp.taxamt"><spring:message code="mortgageRelex.secLeg.secGenLeg.frstLeg.taxImp.taxamt" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.genid"><spring:message code="mortgageRelex.secLeg.secGenLeg.genid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.isin"><spring:message code="mortgageRelex.secLeg.isin" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.stlmdt"><spring:message code="mortgageRelex.stlmdt" /></form:label></td>
					<td><form:input path="body.stlmdt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.cntrid"><spring:message code="mortgageRelex.cntrid" /></form:label></td>
					<td><form:input path="body.cntrid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.prtyid"><spring:message code="mortgageRelex.prtyid" /></form:label></td>
					<td><form:input path="body.prtyid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.cprtyid"><spring:message code="mortgageRelex.cprtyid" /></form:label></td>

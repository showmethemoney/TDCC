	...
	<form:form method="POST" action="SecBlk" modelAttribute="model">
		<table>
			...
			<tbody>
				...
				<tr>
					<td><form:label path="body.stlmprty.prtyid"><span class="required">＊</span><spring:message code="setBlk.stlmprty.prtyid" /></form:label></td>
					<td><form:input path="body.stlmprty.prtyid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.stlmprty.acctid"><span class="required">＊</span><spring:message code="setBlk.stlmprty.acctid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.stlmdt"><span class="required">＊</span><spring:message code="setBlk.stlmdt" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.isin"><span class="required">＊</span><spring:message code="setBlk.secLeg.isin" /></form:label></td>
					<td><form:input path="body.secLeg.isin" /></td>
				</tr>				
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.genid"><span class="required">＊</span><spring:message code="setBlk.secLeg.secGenLeg.genid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.secUnitsLeg.units"><span class="required">＊</span><spring:message code="setBlk.secLeg.secGenLeg.secUnitsLeg.units" /></form:label></td>
					<td><form:input path="body.secLeg.secGenLeg.secUnitsLeg.units" /></td>
				</tr>
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.secUnitsLeg.uval"><span class="required">＊</span><spring:message code="setBlk.secLeg.secGenLeg.secUnitsLeg.uval" /></form:label></td>

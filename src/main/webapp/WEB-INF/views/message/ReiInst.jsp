	...
	<form:form method="POST" action="ReiInst" modelAttribute="model">
		<table>
			...
			<tbody>
				...
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.genid"><spring:message code="reiInst.secLeg.secGenLeg.genid" /></form:label></td>
					<td><form:input path="body.secLeg.secGenLeg.genid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.secLeg.secGenLeg.secamt"><spring:message code="reiInst.secLeg.secGenLeg.secamt" /></form:label></td>
					<td><form:input path="body.secLeg.secGenLeg.secamt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.secLeg.isin"><spring:message code="reiInst.secLeg.isin" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.cshLeg.cshamt"><spring:message code="reiInst.cshLeg.cshamt" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.receiverBank.cshLeg.cshamt"><spring:message code="reiInst.receiverBank.cshLeg.cshamt" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.receiverBank.id"><spring:message code="reiInst.receiverBank.id" /></form:label></td>
					<td><form:input path="body.receiverBank.id" /></td>
				</tr>
				<tr>
					<td><form:label path="body.receiverBank.bnfynm"><spring:message code="reiInst.receiverBank.bnfynm" /></form:label></td>
					<td><form:input path="body.receiverBank.bnfynm" /></td>
				</tr>
				<tr>
					<td><form:label path="body.receiverBank.acctid"><spring:message code="reiInst.receiverBank.acctid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.stlmprty.prtyid"><spring:message code="reiInst.stlmprty.prtyid" /></form:label></td>
					<td><form:input path="body.stlmprty.prtyid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.stlmprty.acctid"><spring:message code="reiInst.stlmprty.acctid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.reiisin"><spring:message code="reiInst.reiisin" /></form:label></td>
					<td><form:input path="body.reiisin" /></td>
				</tr>
				<tr>
					<td><form:label path="body.stlmdt"><spring:message code="reiInst.stlmdt" /></form:label></td>
					<td><form:input path="body.stlmdt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.bsprc"><spring:message code="reiInst.bsprc" /></form:label></td>
					<td><form:input path="body.bsprc" /></td>
				</tr>
				<tr>
					<td><form:label path="body.rdmptaxamt"><spring:message code="reiInst.rdmptaxamt" /></form:label></td>
					<td><form:input path="body.rdmptaxamt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.trdrt"><spring:message code="reiInst.trdrt" /></form:label></td>

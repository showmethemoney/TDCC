	...
	<form:form method="POST" action="Dep" modelAttribute="model">
		<table>
			...
			<tbody>
				...
				<tr>
					<td><form:label path="body.denomination.id"><spring:message code="dep.denomination.id" /></form:label></td>
					<td><form:input path="body.denomination.id" /></td>
				</tr>
				<tr>
					<td><form:label path="body.denomination.fval"><spring:message code="dep.denomination.fval" /></form:label></td>
					<td><form:input path="body.denomination.fval" /></td>
				</tr>
				<tr>
					<td><form:label path="body.denomination.uval"><spring:message code="dep.denomination.uval" /></form:label></td>
					<td><form:input path="body.denomination.uval" /></td>
				</tr>
				<tr>
					<td><form:label path="body.denomination.units"><spring:message code="dep.denomination.units" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.endorsee.endid"><spring:message code="dep.endorsee.endid" /></form:label></td>
					<td><form:input path="body.endorsee.endid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.endorsee.endaddr"><spring:message code="dep.endorsee.endaddr" /></form:label></td>
					<td><form:input path="body.endorsee.endaddr" /></td>
				</tr>

				<tr>
					<td><form:label path="body.agreer.agrid"><spring:message code="dep.agreer.agrid" /></form:label></td>
					<td><form:input path="body.agreer.agrid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.agreer.agrmref"><spring:message code="dep.agreer.agrmref" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.isin"><spring:message code="dep.isin" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.issrnm"><spring:message code="dep.issrnm" /></form:label></td>
					<td><form:input path="body.issrnm" /></td>
				</tr>
				<tr>
					<td><form:label path="body.issrid"><spring:message code="dep.issrid" /></form:label></td>
					<td><form:input path="body.issrid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.issrbuscode"><spring:message code="dep.issrbuscode" /></form:label></td>
					<td><form:input path="body.issrbuscode" /></td>
				</tr>
				<tr>
					<td><form:label path="body.issrgrpid"><spring:message code="dep.issrgrpid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.prtyid"><spring:message code="dep.prtyid" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.psdbid"><spring:message code="dep.psdbid" /></form:label></td>
					<td><form:input path="body.psdbid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.brnchid"><spring:message code="dep.brnchid" /></form:label></td>
					<td><form:input path="body.brnchid" /></td>
				</tr>
				<tr>
					<td><form:label path="body.fval"><spring:message code="dep.fval" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.issdays"><spring:message code="dep.issdays" /></form:label></td>
					<td><form:input path="body.issdays" /></td>
				</tr>
				<tr>
					<td><form:label path="body.issdt"><spring:message code="dep.issdt" /></form:label></td>
					<td><form:input path="body.issdt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.depdt"><spring:message code="dep.depdt" /></form:label></td>
					<td><form:input path="body.depdt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.selldt"><spring:message code="dep.selldt" /></form:label></td>
					<td><form:input path="body.selldt" /></td>
				</tr>
				<tr>
					<td><form:label path="body.matdt"><spring:message code="dep.matdt" /></form:label></td>
				...
				<tr>
					<td><form:label path="body.thmatdt"><spring:message code="dep.thmatdt" /></form:label></td>
